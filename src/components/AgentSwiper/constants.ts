export const agents = [
  {
    ...
    description: [
      ...
      "Specjalizuje się w prawie upadłościowym i restrukturyzacyjnym. Reprezentuje przedsiębiorców, w tym rolników prowadzących gospodarstwa rolne, we wszystkich rodzajach postępowań restrukturyzacyjnych, a także przedsiębiorców i osoby fizyczne nieprowadzące działalności gospodarczej w postępowaniach upadłościowych na każdym etapie postępowania.",
      "Prowadzi także sprawy z zakresu dochodzenia roszczeń odszkodowawczych oraz o zadośćuczynienie za krzywdę, w tym z tytułu błędów medycznych. Posiada także doświadczenie w dochodzeniu roszczeń z umów kredytów frankowych.",
      "Ponadto, świadczy usługi prawne w zakresie szeroko pojętego prawa cywilnego oraz gospodarczego, ze szczególnym uwzględnieniem tematyki prawa zobowiązań. Świadczy również stałą obsługę prawną na rzecz przedsiębiorców.",
  ...
  },
  {
    ...
    description: [
      ...
      "Posiada bogate doświadczenie w sporządzeniu pism z zakresu restrukturyzacji i upadłości, postępowania cywilnego i gospodarczego, umów oraz opinii prawnych, jak również od początku swojej pracy brał czynny udział w postępowaniach sądowych.",
      "Włada językiem angielskim.",
    ],
    spec: "Radca prawny",
  },
